...
/// Nested here so private guard methods stay in one module (avoids rust-analyzer false positives on sibling files).
...
use block_submit_guard::{remove_block_submit, try_mark_block_submit};
